    ...
    loadMap() {
     ...
     //   this.listOfSmallPlants.push(new ForestSmallPlant(this.game, 1550, 930, PlantType.PURPLEFLOWER));
      ...
      //  this.dog.removeFromWorld = false;
        ...
        this.listOfBuildingsBlOCKCharacter.push(new InvisibleFenceBlocker(this.game, 64*21,300,700, 80));
        this.listOfBuildingsBlOCKCharacter.push(new InvisibleFenceBlocker(this.game, 64*22+40,370,500, 80));
